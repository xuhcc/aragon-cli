import { WARNING_ICON, ERROR_ICON } from '@aragon/cli-utils/src/reporters/ConsoleReporter'
...
Use '$0 <command> --help' to learn more about each command.
For more information, check out https://hack.aragon.org
`
export const COMMAND_REQUIRED_ERROR = `${ERROR_ICON} You need to specify a command`
export const HELP_COMMAND_WARNING = `${WARNING_ICON} Specify --help for available commands`
